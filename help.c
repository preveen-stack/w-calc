...
void print_interactive_help (void)
{
	...
	printf( "This calculator recognizes the following symbols:\n"
		 ...
		 "\\r or \\radians toggles radian mode for trigonometric functions.\n"
		 ...
		 "\\ints toggles whether long integers will be abbreviated or not\n"
		 "    (conflicts with engineering notation for large numbers, but not for decimals).\n"
