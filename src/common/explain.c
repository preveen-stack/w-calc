...
{                                      /*{{{ */
    ...
    if (!strcmp(str, "b") || !strcmp(str, "bin") || !strcmp(str, "binary")) {
        ...
        printf("Saves the variable specified in the preload file, ~/.wcalc_preload. Use like so: \\store variablename\n");
        ...
        printf("This toggles the formatting of output such that delimiters are inserted in integers.\n");
    } else if (!strcmp(str, "dsep")) {
        printf("Used like so: \\dsepX This sets the decimal separator to X. By default, it is a period (.).\n");
    } else if (!strcmp(str, "e") || !strcmp(str, "eng") ||
               !strcmp(str, "engineering")) {
        printf("This toggles the formatting of output between decimal and scientific notation.\n");
        ...
        printf("This places (or removes) a limit on the number of things stored in the history. Use like this: \\hlimitX where X is a number. 0 removes the limit.\n");
    } else if (!strcmp(str, "ints")) {
        printf("Toggles whether long integers will be abbreviated or not (conflicts with engineering notation for large numbers, but not for decimals).\n");
        ...
        printf("Sets the precision. Use it like so: \\pX where X is the desired precision. Precision here is in digits. This setting only affects display. -1 means \"auto\".\n");
        ...
        printf("Sets the number of bits used internally to represent numbers. Used like this: \\bitsX where X is a number that must be above %li and below %li.\n",
        ...
        printf("Used like this: \\tsepX Sets the thousands-place separator character to X. The default is a comma (,).\n");
    } else if (!strcmp(str, "c") || !strcmp(str, "conv") ||
               !strcmp(str, "convert")) {
        printf("Used either like this: \"\\convert unit1 to unit2\" or like this: \"\\convert unit1 unit2\". Converts the previous answer from the first unit to the second.\n");
    } else if (!strcmp(str, "base")) {
        printf("Prints out the previous answer in any base from 2 to 36.\n");
    } else if (!strcmp(str, "verbose")) {
        printf("Prints out the lines to be evaluated before evaluating them.\n");
    } else if (!strcmp(str, "explain")) {
        printf("Gives you information about commands, variables, constants and functions.\n");
...
{                                      /*{{{ */
    switch (isconst(str)) {
        case W_e:
            printf("The base of the natural logarithm function. Arbitrary precision. Occasionally called Euler's Number (after Leonhard Eulter) or Napier's Constant (after John Napier).");
            break;
        case W_pi:
            printf("The ratio of a circle's circumference to its diameter. Arbitrary precision.");
            break;
        case W_random:
        ...
        case W_Na:
            ...
            break;
        case W_k:
            printf("Boltzmann's Constant. The physical constant relating temperature to energy.");
            break;
        case W_Cc:
            printf("Coulomb force constant. Equal to 1/(4*pi*epsilonzero).");
            break;
        case W_ec:
            printf("Elementary charge. The electric charge carried by a single proton.");
            break;
        case W_R:
            printf("Molar Gas Constant. Used in equations of state to relate various groups of state functions to one another.");
            break;
        case W_G:
        ...
        case W_Md:
            ...
            break;
        case W_u:
            printf("Atomic mass unit. One twelfth of the mean mass of an atop of carbon 12 in its nuclear and electronic ground state.");
            break;
        case W_c:
            printf("The speed of light.");
            break;
        case W_h:
            printf("Planck Constant. Used to describe the sizes of quanta, central to the theory of quantum mechanics.");
            break;
        case W_mu0:
            printf("Permeability of free space. Also known as the magnetic constant.");
            break;
        case W_epsilon0:
        ...
        case W_muB:
            ...
            break;
        case W_muN:
            printf("Nuclear magneton. A physical constant of magnetic moment.");
            break;
        case W_b:
            printf("Wein displacement constant. Defines the relationship between the thermodynamic temperature of a black body and the wavelength at which the intensity of the radiation is the greatest.");
            break;
        case W_a0:
            printf("Bohr radius. A single electron orbiting at the lowest possible energy in a hydrogen atom orbits at this distance.");
            break;
        case W_F:
            printf("Faraday constant. The amount of electric charge in one mole of electrons.");
            break;
        case W_Vm:
            printf("Molar volume of ideal gas.");
            break;
        case W_eV:
            printf("Electron volt. The amount of kinetic energy gained by a single unbound electron when it passes through an electrostatic potential difference of one volt, in vacuum.");
            break;
        case W_sigma:
            printf("Stefan-Boltzmann constant. The constant of proportionality between the total energy radiated per unit surface area of a black body in unit time and the fourth power of the thermodynamic temperature, as per the Stefan-Boltzmann law.");
            break;
        case W_alpha:
            printf("Fine-structure constant. The fundamental physical constant characterizing the strength of the electromagnetic interaction.");
            break;
        case W_gamma:
            printf("Euler-Mascheroni constant. Used mainly in number theory, defined as the limiting difference between the harmonic series and the natural logarithm.");
            break;
        case W_re:
            printf("Electron radius, also known as the Compton radius or the Thomson scattering length based on a classical relativistic model of the electron.");
            break;
        case W_Kj:
            printf("Josephson Constant. The inverse of the magnetic flux quantum.");
            break;
        case W_Rk:
            printf("von Klitzing constant. Named after Klaus von Klitzing, the basic resistance unit.");
            break;
        case W_Rinf:
            printf("The \"infinity\" Rydberg constant, named after physicist Janne Rydberg. Used to calculate the Rydberg constant of any other chemical element.");
            break;
        case W_Eh:
            printf("Hartree energy. The atomic unit of energy, named after physicist Douglas Hartree.");
            break;
        case W_Gf:
        ...
        case W_Malpha:
            ...
            break;
        case W_n0:
            printf("Loschmidt constant. The number of molecules in a cubic meter of ideal gas. Equal to the Avogadro constant divided by molar volume.");
            break;
        case W_c1:
        ...
        case W_G0:
            ...
            break;
        case W_Z0:
            printf("Characteristic impedance of vacuum, the characteristic impedance of electromagnetic radiation in vacuum. Equal to mu0*c.");
            break;
        case W_Phi0:
            printf("Magnetic flux quantum. The quantum of magnetic flux passing through a superconductor.");
            break;
        case W_K:
            ...
            break;
        case W_Inf:
            printf("This represents infinity. This is a \"special\" number that has specific (unusual) mathematical consequences.");
            break;
        case W_NaN:
            printf("Not-a-number. This is a \"special\" number that has specific (unusual) mathematical consequences.");
            break;
        case W_half:
        ...
        case W_threequarters:
            ...
            break;
        case W_notaconstant:
            printf("This is not a constant... you should not be seeing this message (report the bug!)");
            break;
    }
    printf("\n");
}                                      /*}}} */
...
{                                      /*{{{ */
    if (!strcmp(str, "sin") || !strcmp(str, "cos") || !strcmp(str, "tan") ||
        ...
        printf("The inverse of the standard hyperbolic trigonometric function.");
        ...
        printf("Returns the biggest integer that is not bigger than the input number.");
    } else if (!strcmp(str, "ceil") || !strcmp(str, "ceiling")) {
        printf("Returns the smallest integer that is not smaller than the input number.");
        ...
        printf("Hrm... this function doesn't have any documentation! Pester the developer!");
    }
    printf("\n");
}                                      /*}}} */
