...
FEATURES:
 - Now supports UTF-8 (BOTH)
 - Improved conversion friendliness (CLI)
 - Added magnetic flux quantum (Phi0) (BOTH)
 - Added \verbose command (CLI)
 - Added \base command to print numbers in any base (CLI)
 - More command-line options (CLI)

BUGFIXES:
 - Fixed bug in storing variables (namely, the 'a' variable) (BOTH)
 - Improved the man page (CLI)
 - Memory leaks and general bugfixes (BOTH)
