...
enum functions {wfact,wsin,wcos,wtan,wasin,wacos,watan,wsinh,wcosh,wtanh,wasinh,wacosh,watanh,wlog,wln};
enum operations {wplus,wminus,wmult,wdiv,wmod,weql,wexp,wor,wand,wequal,wnequal,wgt,wlt,wgeq,wleq};
